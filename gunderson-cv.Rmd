...
address: ""
fontawesome: yes
email: chrisagunderson@gmail.com
...
Dissertation: _Interrupting Holistic Processing May Improve \newline the Detection of Deceptive Emotional Facial Expressions_  
...
Thesis: _The Moderating Effect of Type of Target on the \newline Relationship Between Collective Rumination and Displaced Aggression_  
...
\quad \hangindent=0.7cm **Gunderson**, C. A., Baker, A., Pence, A. D., & ten Brinke, L. M. (2021). Interpersonal consequences of deceptive expressions of sadness. _Personality and Social Psychology Bulletin_. https://doi.org/10.1177/01461672211059700
...
\quad \hangindent=0.7cm  **Gunderson**, C. A., Vo, T. V. A. , Harriot, B., Kam, C., & ten Brinke, L. M. In search of duping delight. _Affective Science_.

## Manuscripts Under Review

\quad \hangindent=0.7cm  **Gunderson**, C. A., ten Brinke, L. M., & Sokol-Hessner, P. When the body knows: Interoceptive accuracy enhances physiological but not explicit differentiation between liars and truth-tellers. Pre-print: https://psyarxiv.com/zs2yu
...
\quad \hangindent=0.7cm  Lloyd, E. P., Summers, K., **Gunderson**, C. A., Weesner, K. A., ten Brinke, L. M., Hugenberg, K., & McConnell, A. R. The Denver Pain Authenticity Stimulus Set (DPASS).  
